...
В данной главе мы рассмотрим адаптацию алгоритма CYK для решения задачи поиска путей с контекстно-свободными ограничениями в графах.
Классический алгоритм CYK для линейного входа (строк) описан в главе, посвящённой классическим алгоритмам синтаксического анализа; здесь же мы сосредоточимся на его обобщении на графы.
