...
\mytodo{Сказать про алгоритмическую (не)разрешимость проверки однозначаности грамматики и возможности алгоритмимчески преобразовать неоднозначную в однозначную. Привести ссылки на работы с подробным изучением этих вопросов.}
...
\mytodo{Поснить пример. Показать интуицию, почему существенно неоднозначный. Сказять что-то про аккуртанео доказательство.}
\begin{example}
