...
\begin{definition}[Отношение выводимости]
    ...
    \begin{itemize}
        ...
        \item $\alpha \derives \beta$~--- $\beta$ выводится из $\alpha$;
        \item $\alpha \derives[k] \beta$~--- $\beta$ выводится из $\alpha$ за $k$ шагов;
...
\begin{definition}[Вывод слова в грамматике]
    Слово $w \in \Sigma^*$ \emph{выводимо в грамматике} $\langle \Sigma, N, P, S \rangle$, если существует некоторый вывод этого слова из начального нетерминала $S \derives w$.
...
\begin{example}
    ...
    \end{align*}
    Жирным выделен нетерминал, заменяемый на каждом шаге вывода.
...
\begin{definition}[Язык]
    \emph{Язык, задаваемый грамматикой}~--- множество строк, выводимых в грамматике $L(G) = \{ w \in \Sigma^* \mid S \derives w \}$.
\end{definition}
