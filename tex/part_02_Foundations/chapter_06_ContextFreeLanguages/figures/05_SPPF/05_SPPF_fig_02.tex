\begin{tikzpicture}[shorten >=1pt,on grid,auto,node distance=0.8cm and 1.2cm]
   \node[symbol_node] (s_0_6)   {$S_{0,6}$};
   \node[prod_node] (p_0_1) [below left=of s_0_6] {$(1)$};
   \node[prod_node,draw=none] (p_0_2) [below right=of s_0_6] {};
   \node[symbol_node] (s_0_4) [below left=of p_0_1]  {$S_{0,4}$};
   \node[symbol_node,draw=none] (s_2_6) [below right=of p_0_2]  {};
   \node[prod_node] (p_0_3) [below =of s_0_4] {$(1)$};
