...
| ✗ | Language Constrained Graph Problems: A Microcosm of Engineering Research and Development | Bradford, Phillip G. | `Bradford:2008:LCG:1373936.1373946` | ✗ |
| ✓ | Formal-Language-Constrained Path Problems | Barrett, C.; Jacob, R.; Marathe, M. | `doi:10.1137/S0097539798337716` | ✓ |
| ✓ | Label constrained shortest path algorithms: An experimental evaluation using transportation networks | Barrett, Chris; Bisset, Keith; Holzer, Martin; Konjevod, Goran; Marathe, Madhav; Wagner, Dorothea | `barrett2007label` | ✓ |
| ✗ | Complexity Results on Labeled Shortest Path Problems from Wireless Routing Metrics | Ward, Charles B.; Wiegand, Nathan M. | `Ward:2010:CRL:1710158.1710234` | ✓ |
...
| ✓ | A faster algorithm for the all-pairs shortest path problem and its application | Takaoka, T. | `Takaoka2004` | ✓ |
| ✓ | An $O(n^3 \log \log n/ \log n)$ time algorithm for the all-pairs shortest path problem | Takaoka, T. | `Takaoka2005` | ✓ |
| ✓ | Improved algorithm for all pairs shortest paths | Han, Yijie | `Han2004` | ✓ |
| ✓ | A slightly improved sub-cubic algorithm for the all pairs shortest paths problem with real edge lengths | Zwick, Uri | `Zwick2004` | ✓ |
| ✗ | An Efficient APSP Algorithm. | Lavall{\'e}e, Ivan; Bui, Marc; Quoc, Trung Ha | `Lavallee2004` | ✗ |
| ✓ | On the all-pairs-shortest-path problem in unweighted undirected graphs | Seidel, Raimund | `Seidel1995` | ✗ |
| ✓ | Gaussian elimination is not optimal | Strassen, Volker | `Strassen1969` | ✓ |
| ✓ | Strassen's algorithm is not optimal trilinear technique of aggregating, uniting and canceling for constructing fast algorithms for matrix operations | Pan, V. Ya. | `Pan1978` | ✓ |
| ✓ | $O(n^{2.7799})$ complexity for approximate matrix multiplication | Bini, Dario Andrea; Capovani, Milvio; Romani, Francesco; Lotti, Grazia | `BiniCapoRoma1979` | ✓ |
| ✓ | Partial and total matrix multiplication | Sch{\"o}nhage, Arnold | `Schonhage1981` | ✓ |
| ✓ | On the asymptotic complexity of matrix multiplication | Coppersmith, Don; Winograd, Shmuel | `CoppWino1982` | ✓ |
| ✓ | Matrix multiplication via arithmetic progressions | Coppersmith, Don; Winograd, Shmuel | `CoppWino1990` | ✓ |
| ✓ | More algorithms for all-pairs shortest paths in weighted graphs | Chan, Timothy M | `Chan2010` | ✓ |
| ✓ | What can we do about the unnecessary diversity of notation for syntactic definitions? | Wirth, Niklaus | `Wirth1977` | ✓ |
| ✓ | Towards a Taxonomy for ECFG and RRPG Parsing | Hemerik, Kees | `Hemerik2009` | ✓ |
...
| ✓ | Estimating probabilistic context-free grammars for proteins using contact map constraints | Witold Dyrka; Mateusz Pyzik; Fran{\c{c}}ois Coste; Hugo Talibart | `Dyrka2019` | ✓ |
| ✓ | Evolving stochastic context--free grammars for {RNA} secondary structure prediction | James WJ Anderson; Paula Tataru; Joe Staines; Jotun Hein; Rune Lyngs{\o} | `WJAnderson2012` | ✓ |
| ✗ | RNA pseudoknot prediction through stochastic conjunctive grammars | Zier-Vogel, Ryan; Domaratzki, Michael | `zier2013rna` | ✓ |
| ✓ | Grammar Variational Autoencoder | Kusner, Matt J.; Paige, Brooks; Hern\'{a}ndez-Lobato, Jos\'{e} Miguel | `10.5555/3305381.3305582` | ✓ |
| ✓ | {TAG} Parsing with Neural Networks and Vector Representations of Supertags | Kasai, Jungo; Frank, Bob; McCoy, Tom; Rambow, Owen; Nasr, Alexis | `kasai-etal-2017-tag` | ✓ |
...
| ✗ | Cusp: Generic Parallel Algorithms for Sparse Matrix and Graph Computations | Steven Dalton; Nathan Bell; Luke Olson; Michael Garland | `Cusp` | ✓ |
| ✓ | Mathematical Foundations of the GraphBLAS | Kepner, Jeremy; Aaltonen, Peter; Bader, David A.; Bulu{\c{c}}, Ayd{\i}n; Franchetti, Franz; Gilbert, John R.; Hutchison, Dylan; Kumar, Manoj; Lumsdaine, Andrew; Meyerhenke, Henning; McMillan, Scott; Yang, Carl; Owens, John D.; Zalewski, Marcin; Mattson, Timothy G.; Moreira, Jos{\'e} E. | `7761646` | ✓ |
| ✗ | Algorithm 9xx: SuiteSparse:GraphBLAS: graph algorithms in the language of sparse linear algebra | Timothy A. Davis | `Davis2018Algorithm9S` | ✓ |
| ✓ | Multiple Lexicalisation (a Java Based Study) | Scott, Elizabeth; Johnstone, Adrian | `10.1145/3357766.3359532` | ✓ |
| ✓ | Two iteration theorems for the LL(k) languages | John C. Beatty | `BEATTY1980193` | ✓ |
| ✓ | КОНКРЕТНАЯ ТЕОРИЯ ГРУПП | Николай Вавилов | `VavilovGroups` | ✓ |
| ✓ | КОНКРЕТНАЯ ТЕОРИЯ КОЛЕЦ | Николай Вавилов | `VavilovRings` | ✓ |
| ✓ | Lower bounds for Combinatorial Algorithms for Boolean Matrix Multiplication | Debarati Das; Michal Koucký; Michael Saks | `das2018lower` | ✓ |
| ✓ | A Refined Laser Method and Faster Matrix Multiplication | Josh Alman; Virginia Vassilevska Williams | `alman2020refined` | ✓ |
| ✓ | Regularity Lemmas and Combinatorial Algorithms | Bansal, Nikhil; Williams, Ryan | `5438580` | ✓ |
| ✓ | An Improved Combinatorial Algorithm for Boolean Matrix Multiplication | Yu, Huacheng | `10.1007/978-3-662-47672-7_89` | ✓ |
| ✓ | Об экономном построении транзитивного замыкания ориентированного графа | В. Арлазаров; Е. Диниц; М. Кронрод; И. Фараджев | `ArlDinKro70` | ✓ |
| ✗ | Graph Algorithms in the Language of Linear Algebra | Kepner, Jeremy; Gilbert, John | `doi:10.1137/1.9780898719918` | ✓ |
| ✓ | Tree Automata Techniques and Applications | H. Comon; M. Dauchet; R. Gilleron; C. L\"oding; F. Jacquemard; D. Lugiez; S. Tison; M. Tommasi | `tata2007` | ✓ |
| ✓ | Path Problems in Networks | J. Baras; George Theodorakopoulos | `Baras2010PathPI` | ✓ |
| ✓ | Introduction to graph grammars with applications to semantic networks | Hartmut Ehrig; Annegret Habel; Hans-Jörg Kreowski | `EHRIG1992557` | ✓ |
| ✓ | Graph Structure and Monadic Second-Order Logic | Bruno Courcelle; Joost Engelfriet | `Courcelle2009` | ✓ |
| ✓ | A GraphBLAS solution to the SIGMOD 2014 Programming Contest using multi-source BFS | Elekes, Márton; Nagy, Attila; Sándor, Dávid; Antal, János Benjamin; Davis, Timothy A.; Szárnyas, Gábor | `9286186` | ✓ |
| ✓ | Single-Source Regular Path Querying in Terms of Linear Algebra | Belyanin, Georgiy; Suvorov, Rodion; Grigorev, Semyon | `belyanin2150single` | ✓ |
...
| ✓ | A method for synthesizing sequential circuits | Mealy, George H. | `6771467` | ✓ |
| ✓ | Extended Finite State Machine | Alagar, V. S.; Periyasamy, K. | `Alagar2011` | ✓ |
| ✓ | A Formal Model of Extended Finite State Machines | Michael Foster; Achim D. Brucker; Ramsay G. Taylor; John Derrick | `foster.ea:efsm:2020` | ✓ |
| ✓ | Analysis of Recursive State Machines | Alur, Rajeev; Benedikt, Michael; Etessami, Kousha; Godefroid, Patrice; Reps, Thomas; Yannakakis, Mihalis | `10.1145/1075382.1075387` | ✓ |
| ✗ | Начала теории множеств | Верещагин, Николай Константинович; Шень, Александр | `верещагин2000начала` | ✓ |
| ✗ | Алгоритмы. Построение и анализ (пер. с англ.) | Кормен, Т.; Лейзерсон, Ч.; Ривест, Р.; Штайн, К. | `кормен2009алгоритмы` | ✓ |
| ✓ | Independent parallelism in finite copying parallel rewriting systems | Rambow, Owen; Satta, Giorgio | `rambow1999independent` | ✓ |
| ✓ | The Pumping Lemma for Well-Nested Multiple Context-Free Languages | Makoto Kanazawa | `kanazawa2009pumping` | ✓ |
| ✗ | Generalized Phrase Structure Grammars, Head Grammars and Natural Language | Carl Pollard | `pollard1984generalized` | ✓ |
| ✓ | The Failure of the Strong Pumping Lemma for Multiple Context-Free Languages | Makoto Kanazawa; Gregory M. Kobele; Jens Michaelis; Sylvain Salvati; Ryo Yoshinaka | `kanazawa2014failure` | ✓ |
| ✓ | Program Analysis via Multiple Context Free Language Reachability | Conrado, Giovanna Kobus; Kjelstr\o{}m, Adam Husted; van de Pol, Jaco; Pavlogiannis, Andreas | `10.1145/3704854` | ✓ |
| ✓ | Staged selective parser combinators | Willis, Jamie; Wu, Nicolas; Pickering, Matthew | `10.1145/3409002` | ✓ |
...
| ✓ | Generalized LR Parsing for Grammars with Contexts | Barash, Mikhail; Okhotin, Alexander | `10.1007/978-3-319-20297-6_5` | ✗ |
| ✓ | An extension of context-free grammars with one-sided context specifications | Barash, Mikhail; Okhotin, Alexander | `10.1016/j.ic.2014.03.003` | ✓ |
| ✓ | Improved normal form for grammars with one-sided contexts | Alexander Okhotin | `OKHOTIN201552` | ✓ |
| ✓ | Ambiguity in context free languages | Ginsburg, Seymour; Ullian, Joseph | `10.1145/321312.321318` | ✓ |
| ✓ | Analyzing ambiguity of context-free grammars | Claus Brabrand; Robert Giegerich; Anders Møller | `BRABRAND2010176` | ✓ |
| ✓ | Tracking Down the Origins of Ambiguity in Context-Free Grammars | Basten, H. J. S. | `10.1007/978-3-642-14808-8_6` | ✓ |
| ✓ | AMBIDEXTER: Practical Ambiguity Detection | Basten, Bas; van der Storm, Tijs | `5601824` | ✓ |
| ✓ | {Ambiguity Detection for Programming Language Grammars} | Basten, Bas | `basten:tel-00644079` | ✓ |
| ✓ | Context-Free Ambiguity Detection Using Multi-stack Pushdown Automata | Basten, H. J. S. | `10.1007/978-3-662-53132-7_1` | ✓ |
| ✓ | Automated Ambiguity Detection in Layout-Sensitive Grammars | Liu, Jiangyi; Zhu, Fengmin; He, Fei | `10.1145/3622838` | ✓ |
...
## Ключи в тексте без bib-записи

Эти ключи найдены в `\cite`/`\sidecite`, но отсутствуют в `.bib`-файле.
